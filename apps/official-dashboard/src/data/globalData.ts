...
export const GLOBAL_ISSUES: GlobalIssue[] = [
  ...
  // moved a couple of sample issues to other world cities (to showcase currency mapping)
  { id: 'CN-001', type: 'streetlight', title: 'Dark Avenue – LED Failure', location: 'Chaoyang Road', city: 'Beijing', country: 'China', continent: 'Asia', lat: 39.9042, lng: 116.4074, severity: 7, status: 'in_progress', roadType: 'Arterial', lastRelayDate: '2021-06-20', contractorName: 'Beijing Power Works', estimatedCost: 85000, currency: 'CNY', reportedAt: '2026-01-15' },
  { id: 'ZA-001-EX', type: 'drainage', title: 'Flooded Underpass – Drainage Block', location: 'Witwatersrand Underpass', city: 'Johannesburg', country: 'South Africa', continent: 'Africa', lat: -26.2041, lng: 28.0473, severity: 8, status: 'in_progress', roadType: 'Arterial', lastRelayDate: '2020-11-10', contractorName: 'Murray & Roberts Civil', estimatedCost: 145000, currency: 'ZAR', reportedAt: '2026-01-28' },
  { id: 'JP-001-EX', type: 'police_booth', title: 'Koban-style Booth Needed', location: 'Shibuya-Ku Local', city: 'Tokyo', country: 'Japan', continent: 'Asia', lat: 35.6590, lng: 139.7006, severity: 8, status: 'critical', roadType: 'Arterial', lastRelayDate: '2023-01-05', contractorName: 'Kajima Corporation', estimatedCost: 3200000, currency: 'JPY', reportedAt: '2026-02-01' },
