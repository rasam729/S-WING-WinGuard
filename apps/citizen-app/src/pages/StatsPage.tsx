...
const StatsPage: React.FC = () => {
  ...
  const [stats] = useState<UserStats>({
    ...
    impactScore: 87,
    routesSaved: 5,
    safetyContribution: 92
  });

  const [recentActivity] = useState([
    { id: 1, action: 'Report Submitted', description: 'Pothole on MG Road', date: '2 hours ago', status: 'pending' },
    { id: 2, action: 'Report Resolved', description: 'Streetlight fixed', date: '1 day ago', status: 'resolved' },
    { id: 3, action: 'Route Saved', description: 'Home to Office (Safe Route)', date: '2 days ago', status: 'saved' },
    { id: 4, action: 'Upvote Received', description: 'Your report helped 5 people', date: '3 days ago', status: 'upvote' }
  ]);
